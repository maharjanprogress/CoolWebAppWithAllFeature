...
public enum TrialBalanceEnum {
    ...
    INTERNET_EXPENCES(1041, "Internet Expenses", "इन्टरनेट खर्चच"),
    ...
    PRADHIKARAN_FEE(1123,"pradhikaran  fee", "प्राधिकरण शुल्क"),
    ...
    ADVANCE_SALARY(1549,"advance salary","अग्रिम तलब"),
    ...
    KASKUN_DAINIK(5007, "KASKUN OPTIONAL SAVING", "कास्कुन वैकल्पिक बचत"),
    ...
    INTEREST_RECEIVABLES(9058, "Interest Receivables", "ब्याज प्राप्तिहरू"),
