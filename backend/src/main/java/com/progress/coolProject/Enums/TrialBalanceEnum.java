...
public enum TrialBalanceEnum {
    ...
    SECURED_CAPITAL_REDEMPTION_FUND(9010, "Secured Capital Redemption Fund (Patronage)", "सुरक्षित पूंजी मोचन कोष"),
    ...
    ADVANCES_PAYABLE(9031, "Advances Payable", "अग्रिम तिर्नुपर्ने"),
